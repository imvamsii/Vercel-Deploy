                    ...
                    <div className={toggleState === 1 ? "qualification__content qualification__content-active"
                        ...
                        <div className="qualification__data">
                            <div>
                                ...
                                <span className="qualification__subtitle">PSCMR CET</span>
                        ...
                        <div className="qualification__data">
                            ...
                            <div>
                                ...
                                <span className="qualification__subtitle">KBN Junior Collge</span>
                                <div className="qualification__calendar">
                                    <HiOutlineCalendar className="qualification__calendar-icon" />
                                    2015-2017
                                </div>
                        ...
                        <div className="qualification__data">
                            <div>
                                ...
                                <span className="qualification__subtitle">Sharada Vidya Nikethan</span>
                                <div className="qualification__calendar">
                                    <HiOutlineCalendar className="qualification__calendar-icon" />
                                    2014-2015
                                </div>
                    ...
                    <div className={toggleState === 2 ? "qualification__content qualification__content-active"
                        ...
                        <div className="qualification__data">
                            ...
                            <div>
                                ...
                                <span className="qualification__subtitle">Intellicrats Infosolutions Pvt Ltd</span>
                                <div className="qualification__calendar">
                                    <HiOutlineCalendar className="qualification__calendar-icon" />
                                    Oct 2021- Jan 2022
                                </div>
