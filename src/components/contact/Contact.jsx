    ...
    return (
        <section className="contact section" id="contact">
            ...
            <div className="contact__container container grid">
                <div className="contact__content">
                    ...
                    <div className="contact__info">
                        ...
                        <div className="contact__card">
                            ...
                            <span className="contact__card-data">vamsyi.krishna1230@gmail.com</span>
                        </div>
                        ...
                        <div className="contact__card">
                            ...
                            <span className="contact__card-data">Hyderabad | Bengaluru | Remote</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="contact__content">
                    <h3 className="contact__title">What's the thing?</h3>
                    ...
                    <form ref={form} onSubmit={sendEmail} className="contact__form">
                        ...
                        <div className="contact__form-div contact__form-area">
                            ...
                            <textarea name="project" cols="30" rows="10" className="contact__form-input" placeholder="Write your content or message here..."></textarea>
                        </div>
